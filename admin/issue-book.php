...
<?php include('includes/header.php');?>
    ...
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Гэрээр ном олгох</h4>
...
Шинэ ном гэрээр олгох
</div>
<div class="panel-body">
<form role="form" method="post">

<div class="form-group">
<label>Сурагчийн ID<span style="color:red;">*</span></label>
...
<div class="form-group">
<label>ISBN код эсвэл номын гарчиг <span style="color:red;">*</span></label>
...
<button type="submit" name="issue" id="submit" class="btn btn-info">Гэрээр олгох</button>

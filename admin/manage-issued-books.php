...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Гэрээр олгосон номын удирдлага</h4>
    </div>
     <div class="row">
...
{               ?>                                      
                                        <tr class="odd gradeX">
                                            ...
                                            <a href="update-issue-bookdeails.php?rid=<?php echo htmlentities($result->rid);?>"><button class="btn btn-primary"><i class="fa fa-edit "></i>Засах</button> 

...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Ном нэмэх</h4>
...
<label>Хавтасны зураг</label>
<img src="bookimg/<?php echo htmlentities($result->bookImage);?>" width="100">
<a href="change-bookimg.php?bookid=<?php echo htmlentities($result->bookid);?>">Хавтасны зураг солих</a>
</div></div>

<div class="col-md-6">
<div class="form-group">
<label>Номын нэр<span style="color:red;">*</span></label>
<input class="form-control" type="text" name="bookname" value="<?php echo htmlentities($result->BookName);?>" required />
</div></div>

<div class="col-md-6">
<div class="form-group">
<label>Төрөл<span style="color:red;">*</span></label>
...
<div class="col-md-6">
<div class="form-group">
<label>Зохиолч<span style="color:red;">*</span></label>
...
<div class="col-md-6">
<div class="form-group">
<label>ISBN код<span style="color:red;">*</span></label>
...
<div class="col-md-6">
 <div class="form-group">
 <label>Номын үнэ (USD)<span style="color:red;">*</span></label>
 <input class="form-control" type="text" name="price" value="<?php echo htmlentities($result->BookPrice);?>"   required="required" />
 </div></div>
 <?php }} ?><div class="col-md-12">
<button type="submit" name="update" class="btn btn-info">Шинэчлэх</button></div>

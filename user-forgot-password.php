...
<div class="col-md-12">
<h4 class="header-line">Хэрэглэгчийн нууц үг сэргээх</h4>
</div>
</div>
...
<label>И-мэйл ID оруулна уу</label>
<input class="form-control" type="email" name="email" required autocomplete="off" />
</div>

<div class="form-group">
<label>Утасны дугаарыг оруулна уу</label>
...
<div class="form-group">
<label>Нууц үгийг батлах</label>
<input class="form-control" type="password" name="confirmpassword" required autocomplete="off"  />
</div>


 <button type="submit" name="change" class="btn btn-info">Нууц үг өөрчлөх</button> | <a href="index.php">Нэвтрэх</a>
</form>
 </div>
</div>
</div>

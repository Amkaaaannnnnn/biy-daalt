...
<?php include('includes/header.php');?>
    ...
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Шинэ ном бүртгэх</h4>
...
<div class="col-md-6">  
<div class="form-group">
<label>Номын төрөл<span style="color:red;">*</span></label>
...
<option value="">Зохиолч сонгох</option>
<?php 
...
<div class="col-md-6">  
 <div class="form-group">
 <label>Үнэ<span style="color:red;">*</span></label>
...
<div class="col-md-6">  
 <div class="form-group">
 <label>Хавтасны зураг<span style="color:red;">*</span></label>
 <input class="form-control" type="file" name="bookpic" autocomplete="off"   required="required" />
 </div>
    </div>
<button type="submit" name="add" id="add" class="btn btn-info">Ном нэмэх </button>
 </div>
</div>
                            </div>

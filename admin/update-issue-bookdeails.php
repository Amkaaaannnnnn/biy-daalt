...
<!-- MENU SECTION END-->
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Гэрээр олгосон номын дэлгэрэнгүй мэдээлэл</h4>
...
Гэрээр олгосон номын дэлгэрэнгүй мэдээлэл
</div>
...
<h4>Сурагчийн дэлгэрэнгүй мэдээлэл</h4>
<hr />
<div class="col-md-6"> 
...
<div class="col-md-6"> 
<div class="form-group">
<label>Сурагчийн И-мэйл хаяг :</label>
<?php echo htmlentities($result->EmailId);?>
</div></div>

<div class="col-md-6"> 
<div class="form-group">
<label>Оюутны холбоо барих дугаар:</label>
<?php echo htmlentities($result->MobileNumber);?>
</div></div>



<h4>номын дэлгэрэнгүй мэдээлэл</h4>
<hr />
...
<div class="col-md-6"> 
<div class="form-group">
<label>Номыг олгосон огноо :</label>
<?php echo htmlentities($result->IssuesDate);?>
</div></div>

<div class="col-md-6"> 
<div class="form-group">
<label>Номыг буцаах огноо :</label>
...
<button type="submit" name="return" id="submit" class="btn btn-info">Ном буцаах</button>

...
<?php include('includes/header.php');?>
    ...
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Миний нүүр хуудас</h4>
...
<div class="form-group">
<label>Хэрэглэгчийн статус: </label>
<?php if($result->Status==1){?>
<span style="color: green">Идэвхтэй</span>
<?php } else { ?>
<span style="color: red">Түгжигдсэн</span>
<?php }?>
</div>
...
<button type="submit" name="update" class="btn btn-primary" id="submit">Шинэчлэх</button>
